...
<div class="space-y-4 grid grid-cols-4">
    <div class="mb-4 pr-4">
        ...
        <input id="zipcode" type="tel" name="zipcode" value="{{old('zipcode')}}" required
               class="cep-mask w-full border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm  @error('zipcode') border-red-500 @enderror">
        @error('zipcode')
    ...
    <div class="mb-4 pr-4 col-span-2">
        ...
        <input id="street" type="tel" name="street" value="{{old('street')}}" required
    ...
    <div class="mb-4 pr-4">
        ...
        <input id="number" type="tel" name="number" required value="{{old('number')}}"
    ...
    <div class="mb-4 pr-4">
        ...
        <input id="complement" type="text" name="complement" required value="{{old('complement')}}"
    ...
    <div class="mb-4 pr-4">
        ...
        <input id="neighborhood" type="text" name="neighborhood" required value="{{old('neighborhood')}}"
    ...
    <div class="mb-4 pr-4">
        ...
        <input id="state" type="text" name="state" required value="{{old('state')}}"
